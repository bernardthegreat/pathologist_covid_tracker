      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-3">
            ...
            <i class="fa fa-plus"> </i> &nbsp;&nbsp;&nbsp;Add Dispositions</button>
        ...
        <div class="card-body">
            ...
            <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  @foreach($disposition as $disposition)   
                <tr>
                  <td> {{$disposition->name}} </td>
                  <td> 

                    @if($disposition->active == '1')
                        Active
                    @else
                        Inactive
                    @endif
                  ...
                  <td> 
                        <a class="btn btn-primary btn-sm" href="{{ route('dispositions.edit', $disposition->id)}} ">
                            <i class="fa fa-user">
                            </i>
                            View
                        </a>
                  ...
                  <td>
                    ...
                    <form class="delete" action="{{ route('dispositions.destroy', $disposition->id)}}" method="post">
                        @csrf
                        @method('DELETE')
